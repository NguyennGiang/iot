...
const ProfileImpl = () => {
    ...
    const listPublicHistory =
        listPublicDevice[listPublicDevice?.length - 1]?.stateHistory;
    return (
        <>
            <NavTop />
            <ContainerPage>
                <MainContainer>
                    <MainCol>
                        <ImageContainer>
                            ...
                            <Title3>
                                Mô tả ngắn về bản thân , có thể bao gồm thông
                                tin về nghề nghiệp, sở thích, kinh nghiệm, mục
                                tiêu nghề nghiệp và nhiều thông tin khác.
                            </Title3>
                        </ImageContainer>
                        <MediaContainer>
                            <Facebook />
                    ...
                    <ImgCol>
                        ...
                        >
                            ...
                            {listPublicDevice.length > 0 &&
                                listPublicDevice?.map((item) => (
                                    <div key={item?._id}>
                                        <Marker
                                            key={item?._id || 1122}
                                            longitude={
