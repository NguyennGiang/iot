...
const PillButton = tw.input`bg-blue-500 hover:bg-blue-700 text-white
 font-bold py-2 px-4 rounded-full border-none w-full mt-4`;
            ...
            <div className="modal-window">
                <ContainerModal>
                    ...
                    >
                        ...
                        <h1 style={{ color: "black" }}>Device</h1>
                        <br />
                        ...
                        <div style={{ float: "right" }}>
                            <label className="switch">
                                <input
                                    type="checkbox"
                                    defaultChecked={item?.connectState === "ON"}
                                    onChange={(e) =>
                                        setStateDevice(
